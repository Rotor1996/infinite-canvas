...
- Grok 视频生成：配置 Sub2API 的 OpenAI 格式渠道并选择 `grok-imagine-video` 或 `grok-imagine-video-1.5` 后，需验证文生视频、单图生视频、基础模型多图参考、任务轮询和生成结果本地保存；同时验证 1.5 多图参考、非单图 1080p 和多图超过 10 秒会显示明确提示。
