                        ...
                        children: (
                            <div>
                                <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                                    <div className="max-w-3xl text-xs leading-5 text-stone-500">每个渠道对应一组 Base URL 和 API Key，并可为模型指定能力或自定义调用脚本。Sub2API 的 OpenAI 与 Grok Key 请分别创建渠道，Base URL 可以相同，模型不要混放。</div>
