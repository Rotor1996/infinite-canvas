...
# 从环境变量生成运行期配置 config.js；未设置的配置保持为空并由前端使用代码默认值。
...
DEFAULT_API_BASE=$(escape_js_string "${DEFAULT_API_BASE_URL:-}")
API_KEY_GUIDE=$(escape_js_string "${API_KEY_GUIDE_URL:-}")
...
window.__RUNTIME_CONFIG__ = {
  ...
  API_KEY_GUIDE_URL: "${API_KEY_GUIDE}"
};
EOF
